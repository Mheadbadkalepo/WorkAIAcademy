        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/ai-jobs" className="text-muted-foreground hover:text-foreground transition-colors">
                  AI Jobs
                </Link>
              </li>
              <li>
                <Link to="/remote-jobs" className="text-muted-foreground hover:text-foreground transition-colors">
                  Remote Jobs
                </Link>
              </li>
              <li>
